...
public class ProfileFargment  extends Fragment {
    ...
    public static final String image="http://192.168.43.197:8084//ElmoezWebService/services/elmoez/removeimage";
...
//
    ...
    public void uploadUserDataToServer(){
        ...
        JsonObjectRequest jsObjRequest = new JsonObjectRequest
                (Request.Method.POST,REMOVE_IMAGE_URL,new JSONObject(user), new Response.Listener<JSONObject>() {
